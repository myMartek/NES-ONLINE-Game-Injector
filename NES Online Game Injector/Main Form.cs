...
namespace NES_Online_Game_Injector
{
    public partial class Form1 : MaterialForm
    {
        ...
        private void InjectButton_Click(object sender, EventArgs e)
        {
            ...
            else if (GamecodeTextbox.Text.Length != 3)
            {
                MessageBox.Show("Enter the unique Game Code (between AAA and ZZZ)", "Error.", MessageBoxButtons.OK);
                return;
            }
            ...
            using (StreamReader CheckGamecode = new StreamReader(TitledbTextbox.Text))
                ...
                {
                    if (line.Contains("CLV-P-N" + GamecodeTextbox.Text + "E"))
                    {
            ...
            {
                string filecheck20 = "NES_ONLINE_Mod/titles/0100D870045B6000/romfs/titles/CLV-P-N" + GamecodeTextbox.Text + "E\\" + "CLV-P-N" + GamecodeTextbox.Text + "E.xtx.z";
                if (File.Exists(filecheck20))
                {
                    MessageBox.Show("Cover file " + GamecodeTextbox.Text + " already exist", "Error");
                    return;
                }
                string filecheck24 = "NES_ONLINE_Mod/titles/0100B4E00444C000/romfs/CLV-P-N" + GamecodeTextbox.Text + "E\\" + "CLV-P-N" + GamecodeTextbox.Text + "E00.xtx.z";
                if (File.Exists(filecheck24))
                {
                    MessageBox.Show("Cover file 355x512 " + GamecodeTextbox.Text + " already exist", "Error");
                    return;
                }
                string filecheck21 = "NES_ONLINE_Mod/titles/0100D870045B6000/romfs/titles/CLV-P-N" + GamecodeTextbox.Text + "E\\" + "CLV-P-N" + GamecodeTextbox.Text + "E.nes";
            ...
            if (JPCheckbox.Checked == false)
            {
                ...
                Directory.CreateDirectory("NES_ONLINE_Mod/titles/0100D870045B6000/romfs/titles/CLV-P-N" + GamecodeTextbox.Text + "E");
                ...
                File.Copy(@"cover.xtx.zlib", "NES_ONLINE_Mod/titles/0100D870045B6000/romfs/titles/CLV-P-N" + GamecodeTextbox.Text + "E\\" + "CLV-P-N" + GamecodeTextbox.Text + "E00.xtx.z");
                File.Delete(@"cover.xtx");
                File.Delete(@"cover.xtx.zlib");

                Zconvert.RunCommand($"screenshot.xtx");
                File.Copy(@"screenshot.xtx.zlib", "NES_ONLINE_Mod/titles/0100D870045B6000/romfs/titles/CLV-P-N" + GamecodeTextbox.Text + "E\\" + "CLV-P-N" + GamecodeTextbox.Text + "E.xtx.z");
                File.Delete(@"screenshot.xtx");
                File.Delete(@"screenshot.xtx.zlib");

                File.Copy(@GamepathTextbox.Text, "NES_ONLINE_Mod/titles/0100D870045B6000/romfs/titles/CLV-P-N" + GamecodeTextbox.Text + "E\\" + "CLV-P-N" + GamecodeTextbox.Text + "E.nes");
                ...
                using (StreamWriter db = new FileInfo("NES_ONLINE_Mod/titles/0100D870045B6000/romfs/titles/lclassics.titlesdb").AppendText())
                {
                    ...
                    db.WriteLine("            \"code\": \"CLV-P-N" + GamecodeTextbox.Text + "E\",");
                    db.WriteLine("            \"rom\": \"/titles/CLV-P-N" + GamecodeTextbox.Text + "E/CLV-P-N" + GamecodeTextbox.Text + "E.nes\",");
                    ...
                    db.WriteLine("            \"cover\": \"/titles/CLV-P-N" + GamecodeTextbox.Text + "E/CLV-P-N" + GamecodeTextbox.Text + "E.xtx.z\",");
                    ...
                    db.WriteLine("            \"details_screen\": \"/titles/CLV-P-N" + GamecodeTextbox.Text + "E/CLV-P-N" + GamecodeTextbox.Text + "E00.xtx.z\",");
            ...
            else if (JPCheckbox.Checked)
            {
                ...
                Directory.CreateDirectory("NES_ONLINE_Mod/titles/0100B4E00444C000/romfs/titles/CLV-D-" + GamecodeTextbox.Text);
